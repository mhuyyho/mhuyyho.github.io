...
Steganography khác với mã hóa (_cryptography_) ở điểm cốt lõi: mã hóa che giấu _nội dung_ của thông tin, còn steganography che giấu _sự tồn tại_ của chính thông tin đó. Nhờ đặc điểm này, một kẻ tấn công có thể truyền đi bí mật quốc gia ngay trong một bức ảnh phong cảnh bình thường, hoặc giấu toàn bộ tài liệu mật bên trong một file ảnh JPEG trông hoàn toàn vô hại.
...
### 2.1. Định Dạng PNG — _Portable Network Graphics_
...
### 2.2 Định Dạng JPEG — _Joint Photographic Experts Group_
...
Khi steghide in ra thông báo _"please specify a file name for the extracted data"_ (tức là payload được nhúng không kèm tên file), ứng dụng sẽ tự động thêm tham số `-xf secret.txt` và chạy lại lệnh:
...
_[Ảnh minh hoạ: `img_steghide_tab.png`]_
...
_[Ảnh minh hoạ: `img_exiftool_tab.png`]_
...
_[Ảnh minh hoạ: `img_bitplane_comparison.png`]_
...
_Lưu ý kỹ thuật:_ PNG sử dụng big-endian 4 bytes (hỗ trợ kích thước tối đa 4.294.967.295 pixels), trong khi JPEG chỉ dùng 2 bytes big-endian (tối đa 65.535 pixels). Ứng dụng tự động phát hiện định dạng file và điều chỉnh trường nào được phép chỉnh sửa, trường nào ở chế độ readonly.
...
_[Ảnh minh hoạ: `img_powershell_extractor.png`]_
...
_[Ảnh minh hoạ: `img_ai_agent_payload.png`]_
...
_[Ảnh minh hoạ: `img_steghide_result.png`]_
...
_[Ảnh minh hoạ: `img_psextract_result.png`]_
...
_[Ảnh minh hoạ: `img_ai_analysis.png`]_
